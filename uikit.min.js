...
(function(we, $e) {
    typeof exports == "object" && typeof module < "u" ? module.exports = $e() : typeof define == "function" && define.amd ? define("uikit", $e) : (we = typeof globalThis < "u" ? globalThis : we || self,
    we.UIkit = $e())
}
)(this, function() {
    "use strict";
    ...
    function ot(t, e, i=0, s=!1) {
        e = T(e);
        const {length: n} = e;
        return n ? (t = vt(t) ? yt(t) : t === "next" ? i + 1 : t === "previous" ? i - 1 : t === "last" ? n - 1 : e.indexOf(F(t)),
        s ? Z(t, 0, n - 1) : (t %= n,
        t < 0 ? t + n : t)) : -1
    }
    function rt(t) {
    ...
    function p(t, e, i) {
        ...
        if (G(i))
            return (s = F(t)) == null ? void 0 : s.getAttribute(e);
        for (const n of T(t))
    ...
    function Vs(t, e, i=200, s, n) {
        return Promise.all(T(t).map(o => new Promise( (r, a) => {
            ...
            ut(e, Ae) && (s && b(o, `uk-transform-origin-${s}`),
            n && b(o, `${Ae}reverse`))
        }
        )))
    }
    ...
    function Rt(t) {
        ...
        for (; t = t.offsetParent; )
            if (e[0] += t.offsetTop + k(c(t, "borderTopWidth")),
    ...
    function Xs(t) {
        ...
        return (i, s) => {
            if (G(s)) {
                ...
                return c(i, t, !s && s !== 0 ? "" : +s + ae(i, t) + "px")
        }
    }
    ...
    const yr = 4;
    function is(t) {
        X.scheduled || (X.scheduled = !0,
        t && t < yr ? Promise.resolve().then( () => es(t)) : requestAnimationFrame( () => es(1)))
    }
    function Js(t) {
        let e;
        for (; e = t.shift(); )
    ...
    function ze(t, e, i={
        ...
        if (Sr)
            return tn(ResizeObserver, t, e, i);
        ...
        function s(r, a, l, h) {
            return new Promise(u => {
                ...
                (function Ke() {
                    ...
                    r.scrollTop = Math[a + ft > 0 ? "max" : "min"](r.scrollTop, f + (a + ft) * Mi),
                    Mi === 1 && (D === ft || !wt--) ? u() : (D = ft,
    ...
    function ue(t, e=!1, i=[]) {
        ...
        [s].concat(n.filter(r => c(r, "overflow").split(" ").some(a => m(["auto", "scroll", ...i], a)) && (!e || r.scrollHeight > lt(r).height))).reverse()
    }
    function bt(...t) {
        return ue(...t)[0]
    }
    ...
    function lt(t) {
        const e = ie(t)
          , {visualViewport: i, document: {documentElement: s}} = e;
        let n = t === cs(t) ? e : t;
        if (te(n) && i) {
        ...
        for (let[r,a,l,h] of [["width", "x", "left", "right"], ["height", "y", "top", "bottom"]]) {
            ...
            const u = o[r] % 1;
            o[r] = o[a] = n[`client${Ct(r)}`] - (u ? u < .5 ? -u : 1 - u : 0),
            o[h] = o[r] + o[l]
        }
        return o
    }
    ...
    function Pr(t, e, i, s) {
        const [n,o,r,a] = ht[s]
          , [l] = gn(t, e)
          , h = lt(l);
        return ["auto", "scroll"].includes(c(l, `overflow-${o}`)) && (h[r] -= l[`scroll${Ct(r)}`],
    ...
    var Br = {
        ...
        methods: {
            start() {
                this.stop(),
                this.update(),
                this.timer || (v(this.$el, "countdownstart"),
            ...
            update() {
                ...
                t.total || (this.stop(),
                this.end || (v(this.$el, "countdownend"),
                this.end = !0));
                for (const e of Dr) {
                    ...
                    s.length !== i.children.length && Ht(i, s.map( () => "<span></span>").join("")),
        ...
        return de({
            handler: function(e, i) {
                ...
                for (const o of T(et(s) ? s(this) : s))
                    z('[loading="lazy"]', o).slice(0, n - 1).forEach(r => Ce(r, "loading"));
    ...
    function yn(t, e, i, s=0) {
        const n = vi(e, !0)
          ...
          , l = a(async () => {
            b(e, bs),
            await Promise.all(Sn(e).map( (u, f) => new Promise(d => setTimeout( () => M.start(u, r, i / 2, "ease").then(d), f * s)))),
            O(e, bs)
        }
        )
          , h = a(async () => {
    ...
    var En = {
        ...
        methods: {
            animate(t, e=this.$el) {
                ...
                return (i === "fade" ? yn : i === "delayed-fade" ? (...n) => yn(...n, 40) : i ? Yr : () => (t(),
                Promise.resolve()))(t, e, this.duration).catch(_)
            }
        }
    };
    const P = {
    ...
    var Kr = {
        ...
        events: {
            ...
            handler(t) {
                t.type === "keydown" && t.keyCode !== P.SPACE || t.target.closest("a,button") && (t.preventDefault(),
        ...
        methods: {
            ...
            async setState(t, e=!0) {
                ...
                for (const i of this.toggles)
                    j(i, this.cls, ta(i, this.attrItem, t));
    ...
    function _n(t, e, i) {
        ...
        return (s || G(o)) && (n ? s ? (delete i.filter[""],
        i.filter[n] = s) : (delete i.filter[n],
        (Se(i.filter) || ""in i.filter) && (i.filter = {
            "": s || ""
        })) : i.filter = {
            "": s || ""
        }),
    ...
    var Ut = {
        ...
        methods: {
            ...
            isToggled(t=this.$el) {
                return t = F(t),
                I(t, this.clsEnter) ? !0 : I(t, this.clsLeave) ? !1 : this.cls ? I(t, this.cls.split(" ")[0]) : W(t)
            },
            _toggle(t, e) {
                if (!t)
                    return;
                e = !!e;
                let i;
                this.cls ? (i = m(this.cls, " ") || e !== I(t, this.cls),
                i && j(t, this.cls, m(this.cls, " ") ? void 0 : e)) : (i = e === t.hidden,
                i && (t.hidden = !e)),
    ...
    function ra(t, e, i) {
        ...
        return e ? (o(t, !0),
        _t.in(t, s[0], n, i.origin)) : _t.out(t, s[1] || s[0], n, i.origin).then( () => o(t, !1))
    }
    const nt = [];
    var xs = {
        mixins: [st, Re, Ut],
        ...
        events: [{
            ...
            handler(t) {
                const {current: e, defaultPrevented: i} = t
                  , {hash: s} = e;
                !i && s && oe(e) && !this.$el.contains(w(s)) ? this.hide() : A(e, this.selClose) && (t.preventDefault(),
                this.hide())
            }
        }, {
            name: "toggle",
            ...
            handler() {
                ...
                c(this.$el, "zIndex", ""),
                nt.some(t => t.clsPage === this.clsPage) || O(document.documentElement, this.clsPage)
            }
        }],
        methods: {
            toggle() {
            ...
            show() {
                return this.container && E(this.$el) !== this.container ? (H(this.container, this.$el),
                new Promise(t => requestAnimationFrame( () => this.show().then(t)))) : this.toggleElement(this.$el, !0, An)
            },
            hide() {
        ...
        methods: {
            ...
            move(t) {
                ...
                for (const d of [this.index, this.prevIndex])
                    m([o, s], d) || (v(i[d], "itemhidden", [this]),
                    u && (f = !0,
                    this.prevIndex = s));
                (this.index === s && this.prevIndex !== s || f) && v(i[this.index], "itemshown", [this]),
                h && (this.prevIndex = s,
                this.index = o,
                !u && v(a, "beforeitemhide", [this]),
                v(l, "beforeitemshow", [this])),
                this._transitioner = this._translate(Math.abs(this.percent), a, !u && l),
                h && (!u && v(a, "itemhide", [this]),
                v(l, "itemshow", [this]))
            },
            end() {
                if (zt(document, Ss, this.move, ks),
    ...
    function va(t, e) {
        for (const {name: i, handler: s, immediate: n=!0} of t._watches)
            (t._initial && n || dt(e, i) && !ti(e[i], t[i])) && s.call(t, t[i], e[i]);
        t._initial = !1
    }
    function ba(t) {
    ...
    function Nn(t, e, i) {
        ...
        Object.defineProperty(t, e, {
            ...
            get() {
                ...
                return dt(s, e) || (s[e] = (i.get || i).call(t, n, o)),
                s[e]
            },
            set(s) {
                const {_computed: n} = t;
    ...
    function Fn(t, e, i) {
        ...
        !(!n || K(n) && !n.length || h && !h.call(t)) && t._events.push($(n, s, l ? N(l) ? l : l.call(t, t) : null, N(o) ? t[o] : o.bind(t), {
            passive: a,
            capture: r,
            self: u
        }))
    ...
    function Wn(t) {
        ...
        for (const a in s) {
            const l = Mt(a);
            let h = Y(n, l);
            G(h) || (h = s[a] === Boolean && h === "" ? !0 : ds(s[a], h),
    ...
    function Ts(t) {
        t._connected && (ge(t, "beforeDisconnect"),
        ka(t),
        Rr(t),
        Ia(t),
        $a(t),
    ...
    function Ma({data: t={}}, {args: e=[], props: i={}}) {
        K(t) && (t = t.slice(0, e.length).reduce( (s, n, o) => (xt(n) ? pt(s, n) : s[e[o]] = n,
        s), {}));
        for (const s in t)
            G(t[s]) ? delete t[s] : i[s] && (t[s] = ds(i[s], t[s]));
        return t
    }
    const ct = function(t) {
        Rn(this, t)
    ...
    function jn(t, e) {
        ...
        const s = Da + Mt(t);
        if (!e)
            return xt(me[s]) && (me[s] = ct.extend(me[s])),
            me[s];
        t = xe(t),
        ct[t] = (o, r) => Ue(t, o, r);
        const n = xt(e) ? {
        ...
        ct._initialized && !n.functional && requestAnimationFrame( () => Ue(t, `[${s}],[data-${s}]`)),
        me[s] = n
    }
    function Ue(t, e, i, ...s) {
        const n = jn(t);
    ...
    var La = {
        ...
        events: [{
            ...
            handler(t) {
                t.target.closest("a,button") && (t.type === "click" || t.keyCode === P.SPACE) && (t.preventDefault(),
                this.show(Y(t.current, this.attrItem)))
            }
        }, {
            name: "itemshow",
            handler: "updateNav"
            ...
            updateNav() {
                ...
                for (const e of this.navItems) {
                    ...
                    if (vt(i)) {
                        ...
                        j(e, "uk-invisible", this.finite && (i === "previous" && t === 0 || i === "next" && t >= this.maxIndex))
                }
            }
        }
    }
      , Vn = {
        ...
        methods: {
            show(t, e=!1) {
                ...
                this.prevIndex = r,
                this.index = l,
                a && !v(a, "beforeitemhide", [this]) || !v(h, "beforeitemshow", [this, a])) {
                    this.index = this.prevIndex,
                    o();
                    return
                }
        ...
        events: [{
            ...
            handler({keyCode: t}) {
                if (!this.isToggled(this.$el) || !this.draggable)
                    return;
                let e = -1;
                t === P.LEFT ? e = "previous" : t === P.RIGHT ? e = "next" : t === P.HOME ? e = 0 : t === P.END && (e = "last"),
                ~e && this.show(e)
            }
        }, {
            name: "beforeitemshow",
    ...
    var qa = {
        ...
        created() {
            ...
            (!e || !W(e)) && (e = H(this.container, `<div class="${this.clsContainer} ${t}"></div>`)),
            this.$mount(H(e, `<div class="${this.clsMsg}${this.status ? ` ${this.clsMsg}-${this.status}` : ""}" role="alert"> <a href class="${this.clsClose}" data-uk-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
    ...
    function Va(t, e) {
        if (N(t)) {
            if (ut(t, "@"))
                t = k(c(e, `--uk-breakpoint-${t.substr(1)}`));
            else if (isNaN(t))
                return t
        }
        ...
        methods: {
            ...
            getCss(t) {
                ...
                for (const i in this.props)
                    this.props[i](e, Z(t));
                return e.willChange = Object.keys(e).map(ni).join(","),
                e
            }
        }
    };
    function ki(t, e, i) {
        ...
        return t === "x" || t === "y" ? (t = `translate${Ct(t)}`,
    ...
    function Es(t, e, i) {
        return i.length === 1 && i.unshift(Ye(e, t, "")),
        i = ve(i, s => Ga(e, s)),
        (s, n) => {
            const [o,r,a] = no(i, n)
              , l = o.map( (h, u) => (h += a * (r[u] - h),
            u === 3 ? k(h) : parseInt(h, 10))).join(",");
            s[t] = `rgba(${l})`
        }
    }
    function Ga(t, e) {
    ...
    var sl = {
        ...
        computed: {
            ...
            sets({sets: t}) {
                ...
                for (let n = 0; n < this.length; n++) {
                    ...
                    e + o > s && (e = 0),
                    this.center ? e < s / 2 && e + o + x(ot(+n + 1, this.slides)).width / 2 > s / 2 && (i.push(+n),
        ...
        events: {
            beforeitemshow(t) {
                ...
                this.duration = Gn(this.avgWidth / this.velocity) * (x(this.slides[i]).width / this.avgWidth),
                this.reorder()
            },
            itemshow() {
    ...
    function nl(t, e) {
        ...
        const {width: i} = x(t);
        if (!e)
            return Math.ceil(Ci(t)) < Math.trunc(i + ol(t));
        const s = B(t)
          , n = Math.trunc(i / 2);
        for (const o in s) {
            const r = s[o]
            ...
            if (h > Dt(s.filter(u => !l.has(u)), u => x(u).width))
                return !0
        }
        return !1
    }
      ...
      , ll = {
        ...
        methods: {
            init(t) {
                ...
                !n || s || i > 0 || ji(e) || e.closest(`.${this.clsNoDrag}`) || this.handle && !e.closest(this.handle) || (t.preventDefault(),
            ...
            move(t) {
                ...
                if (zt(document, ui, this.move),
                zt(document, At, this.end),
                !this.drag)
                    return;
                cl();
                const t = this.getSortable(this.placeholder);
                this === t ? this.origin.index !== ne(this.placeholder) && v(this.$el, "moved", [this, this.placeholder]) : (v(t.$el, "added", [t, this.placeholder]),
    ...
    function hl(t) {
        ...
        mo = setInterval( () => {
            ...
            e = Date.now(),
            ue(document.elementFromPoint(i, t.y)).reverse().some(o => {
    ...
    var ml = {
        ...
        methods: {
            ...
            async hide() {
                var t;
                A(this.$el, "input:focus") || (clearTimeout(this.showTimer),
    ...
    var ko = {
        ...
        events: [{
            ...
            async handler(t) {
                var e;
                t.type === "keydown" && t.keyCode !== P.SPACE || (t.preventDefault(),
        ...
        methods: {
            toggle(t, e) {
                ...
                if (!this.multiple && !m(s, i[0]) && (i = i.concat(s)),
    ...
    var Ol = {
        ...
        methods: {
            async close() {
                await this.toggleElement(this.$el, !1, Al),
                this.$destroy(!0)
            }
        }
    };
    ...
    var So = {
        ...
        connected() {
            this.autoplay === "inview" && !kt(this.$el, "preload") && (this.$el.preload = "none"),
            q(this.$el, "iframe") && !kt(this.$el, "allow") && (this.$el.allow = "autoplay"),
    ...
    var To = {
        ...
        events: [{
            ...
            handler(t) {
                t.preventDefault(),
                A(this.$el, ":focus,:hover") || this.hide()
            }
        }, {
            name: `${ce} focusin`,
            filter() {
        ...
        methods: {
            show(t=this.targetEl, e=!0) {
                ...
                !this.isActive()) {
                    ...
                    this.container && E(this.$el) !== this.container && H(this.container, this.$el),
    ...
    function Dl(t) {
        const e = [];
        return It(t, i => c(i, "position") !== "static" && e.push(i)),
        e
    }
    function Bl(t, e) {
    ...
    var Po = {
        ...
        computed: {
            ...
            dropbar({dropbar: t}) {
                return t ? (t = this._dropbar || it(t, this.$el) || w(`+ .${this.clsDropbar}`, this.$el),
        ...
        events: [{
            ...
            handler(t) {
                ...
                const {current: i, keyCode: s} = t
                  , n = this.getActive();
                s === P.DOWN && (n == null ? void 0 : n.targetEl) === i && (t.preventDefault(),
                (e = w(Ee, n.$el)) == null || e.focus()),
                _o(t, this.items, n)
            }
        }, {
            name: "keydown",
            ...
            handler(t) {
                ...
                let o = -1;
                if (s === P.HOME ? o = 0 : s === P.END ? o = "last" : s === P.UP ? o = "previous" : s === P.DOWN ? o = "next" : s === P.ESC && ((e = n.targetEl) == null || e.focus()),
                ~o) {
                    t.preventDefault();
                    const r = z(Ee, i);
            ...
            handler({target: t}) {
                this.isDropbarDrop(t) && (this.dropbar.previousElementSibling !== this.dropbarAnchor && ai(this.dropbarAnchor, this.dropbar),
                ...
                const e = this.getDropdown(t)
                  , i = () => {
                    const s = Nt(t, `.${this.clsDrop}`).concat(t).map(a => S(a))
                      ...
                      , r = S(this.dropbar);
                    c(this.dropbar, "top", this.dropbar.offsetTop - (r.top - n) - this.dropbarOffset),
                    this.transitionTo(o - n + k(c(t, "marginBottom")) + this.dropbarOffset, t)
                }
                ;
    ...
    function _o(t, e, i) {
        ...
        let l = -1;
        a === P.HOME ? l = 0 : a === P.END ? l = "last" : a === P.LEFT ? l = "previous" : a === P.RIGHT ? l = "next" : a === P.TAB && ((s = i.targetEl) == null || s.focus(),
      ...
      , Rl = {
        ...
        update: [{
            ...
            read(t) {
                ...
                if (s = Math.max(0, Q(s)),
                !(i || s || n) || Oo(e) || e[0].some( (y, C) => e.some(D => D[C] && D[C].offsetWidth !== y.offsetWidth)))
                ...
                const h = a.map(y => Dt(y, "offsetHeight") + r * (y.length - 1))
                  , u = Math.max(0, ...h);
                let f, d, g;
                return (s || n) && (f = h.map( (y, C) => n ? u - y + s : s / (C % 2 || 8)),
      ...
      , Ao = {
        ...
        connected() {
            this.svg = this.getSvg().then(t => {
                ...
                return this.svgEl && e !== this.svgEl && at(this.svgEl),
                vh.call(this, e, t),
                this.svgEl = e
            }
            , _)
        ...
        disconnected() {
            this.svg.then(t => {
                this._connected || (Ri(this.$el) && (this.$el.hidden = !1),
                at(t),
                this.svgEl = null)
            }
            ),
    ...
    const _i = {
      ...
      , wh = {
        ...
        beforeConnect() {
            if (this.icon = I(this.$el, "uk-search-icon") && Nt(this.$el, ".uk-search-large").length ? "search-large" : Nt(this.$el, ".uk-search-navbar").length ? "search-navbar" : this.$props.icon,
      ...
      , $h = {
        ...
        methods: {
            async getSvg() {
                ...
                return this.ratio !== 1 && c(w("circle", t), "strokeWidth", 1 / this.ratio),
                t
            }
        }
    }
    ...
    function Eh(t) {
        return _i[t] ? (Oi[t] || (Oi[t] = w((_i[Ph(t)] || _i[t]).trim())),
        Oi[t].cloneNode(!0)) : null
    }
    function Ph(t) {
    ...
    var Oh = {
        ...
        connected() {
            ...
            _h && Ai(this.$el) && (this.$el.loading = "lazy",
            Ms(this.$el)),
            Nh(this.$el)
        },
        disconnected() {
    ...
    function Ms(t, e) {
        if (Ai(t)) {
            ...
            e && !m(t.style.backgroundImage, e) && (c(t, "backgroundImage", `url(${Vi(e)})`),
            v(t, Ft("load", !1)))
    }
      ...
      , Wh = {
        ...
        watch: {
            items() {
                ...
                for (const e of z(".uk-navbar-nav, .uk-navbar-left, .uk-navbar-right", this.$el))
                    c(e, "flexGrow", t ? z(".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle", e).length : "")
            }
        },
        disconnect() {
            var t;
        ...
        events: [{
            ...
            handler({target: t}) {
                ...
                if (e === "behind") {
                    const s = No(this.$el);
                    s && (i(),
                    b(this.navbarContainer, `uk-${s}`))
                }
                e === "remove" && (i(),
                O(this.navbarContainer, "uk-navbar-transparent"))
            }
        }, {
            name: "hide",
            el() {
            ...
            async handler({target: t}) {
                ...
                !this.getActive())) {
                    ...
                    e === "remove" && b(this.navbarContainer, "uk-navbar-transparent"),
                    this._mode = null
                }
            }
        }],
    ...
    var Vh = {
        ...
        events: [{
            ...
            self: !0,
            handler() {
                this.mode === "reveal" && !I(E(this.panel), this.clsMode) && (hi(this.panel, "<div>"),
                b(E(this.panel), this.clsMode));
      ...
      , Kh = {
        ...
        methods: {
            async scrollTo(t) {
                ...
                v(this.$el, "beforescroll", [this, t]) && (await hn(t, {
                    offset: this.offset
                }),
    ...
    const Je = new Set;
    function Zh(t) {
        Je.size || $(document, "click", Fo),
        Je.add(t)
    }
    function Qh(t) {
        Je.delete(t),
        Je.size || zt(document, "click", Fo)
    }
    function Fo(t) {
        if (!t.defaultPrevented)
            for (const e of Je)
                e.$el.contains(t.target) && oe(e.$el) && (t.preventDefault(),
    ...
    var tc = {
      ...
      , ic = {
        ...
        connected() {
            ...
            this.placeholder = w("+ .uk-sticky-placeholder", this.$el) || w('<div class="uk-sticky-placeholder"></div>'),
            this.isFixed = !1,
            this.setActive(!1)
        },
        beforeDisconnect() {
        ...
        update: [{
            read({height: t, width: e, margin: i, sticky: s}) {
                ...
                n && (Wo(this.$el),
                this.hide()),
                this.active || ({height: t, width: e} = S(this.$el),
                i = c(this.$el, "margin")),
                n && this.show();
            ...
            write({height: t, width: e, margin: i, offset: s, sticky: n}) {
                if ((this.inactive || n || !this.isFixed) && Lo(this.$el),
                this.inactive)
                    return;
                n && (t = e = i = 0,
                c(this.$el, {
            ...
            write(t, e) {
                ...
                !(this.showOnUp && !this.isFixed && Math.abs(t.initScroll - r) <= 30 && Math.abs(a - r) <= 10))
                    if (this.inactive || r < h || this.showOnUp && (r <= h || n === "down" && i || n === "up" && !this.isFixed && r <= u + f)) {
                        if (!this.isFixed) {
                            _t.inProgress(this.$el) && l > r && (_t.cancel(this.$el),
                            this.hide());
                            return
                        }
                        if (this.animation && r > u) {
                            if (I(this.$el, "uk-animation-leave"))
                                return;
                            _t.out(this.$el, this.animation).then( () => this.hide(), _)
                        } else
                            this.hide()
                    } else
                        this.isFixed ? this.update() : this.animation && r > u ? (this.show(),
                        _t.in(this.$el, this.animation).catch(_)) : (Wo(this.selTarget),
                        this.show())
            },
        ...
        methods: {
            ...
            setActive(t) {
                const e = this.active;
                this.active = t,
                t ? (ii(this.selTarget, this.clsInactive, this.clsActive),
                e !== t && v(this.$el, "active")) : (ii(this.selTarget, this.clsActive, this.clsInactive),
    ...
    function oc(t, e) {
        return e && m(t, "<symbol") && (t = rc(t)[e] || t),
    ...
    var qo = {
        ...
        events: [{
            ...
            handler(t) {
                !A(t.current, Bs) && (t.type === "click" || t.keyCode === P.SPACE) && (t.preventDefault(),
                this.show(t.current))
            }
        }, {
            name: "keydown",
    ...
    var cc = {
        ...
        computed: {
            target({target: t}, e) {
                return t = _e(t || e.hash, e),
                t.length ? t : [e]
            }
        },
        connected() {
            m(this.mode, "media") || (si(this.$el) || p(this.$el, "tabindex", "0"),
        ...
        events: [{
            ...
            handler(t) {
                ...
                !(!St(t) || ee(this._showState) || this.$el.disabled) && (v(this.$el, "focus"),
                R(document, gt, () => v(this.$el, "blur"), !0, e => !this.$el.contains(e.target)),
            ...
            handler(t) {
                let e;
                (this._preventClick || t.target.closest('a[href="#"], a[href=""]') || (e = t.target.closest("a[href]")) && (!this.isToggled(this.target) || e.hash && A(this.target, e.hash))) && t.preventDefault(),
        ...
        methods: {
            async toggle(t) {
                if (!v(this.target, t || "toggle", [this]))
                    return;
                if (kt(this.$el, "aria-expanded") && p(this.$el, "aria-expanded", !this.isToggled(this.target)),
                !this.queued)
    ...
    return Pt(uc, (t, e) => ct.component(e, t)),
    Il(ct),
